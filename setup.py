...
DESCRIPTION = (
    ...
    ' For training, please use the github training repository.')

URL = 'https://github.com/earthspecies/biodenoising-inference-internal'
...
setup(
    ...
    url=URL,
    packages=['biodenoising','biodenoising.denoiser'],
